...
public class IpPoolListKey extends com.cisco.singtel.resourcemanager.base.KeyBase implements Comparable<IpPoolListKey> {
    private com.tailf.conf.ConfKey confKey;

    private java.lang.String _name;

    public IpPoolListKey(com.tailf.conf.ConfKey confKey) {
        this.confKey = confKey;
    }

    public IpPoolListKey(java.lang.String name) {
        this._name = name;
    }
    ...
    @Override
    public int compareTo(IpPoolListKey other) {
        int diff = 0;
