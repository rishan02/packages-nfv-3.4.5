...
public class IdPoolListKey extends com.cisco.singtel.resourcemanager.base.KeyBase implements Comparable<IdPoolListKey> {
    private com.tailf.conf.ConfKey confKey;

    private java.lang.String _name;

    public IdPoolListKey(com.tailf.conf.ConfKey confKey) {
        this.confKey = confKey;
    }

    public IdPoolListKey(java.lang.String name) {
        this._name = name;
    }
    ...
    @Override
    public int compareTo(IdPoolListKey other) {
        int diff = 0;
