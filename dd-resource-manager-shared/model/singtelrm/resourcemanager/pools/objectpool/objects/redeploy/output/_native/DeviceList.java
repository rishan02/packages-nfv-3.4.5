...
public class DeviceList extends com.cisco.singtel.resourcemanager.base.ParameterTreeNode implements java.lang.Iterable<Device> {
    ...
    private com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.output.Native parent;
    private boolean exists = false;
    private final java.util.SortedMap<DeviceListKey, Device> elemCache = new java.util.TreeMap<>();

    public DeviceList(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.output.Native parent) {
        super(null);
        this.parent = parent;
    }
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.output.Native _parent() {
        if (this.parent == null) {
            this.parent = new com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.output.Native(this._getPath().getParent());
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.output.Native _attach(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.output.Native parent) {
        if (this.parent != parent) {
            if (this.parent != null) {
                com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.output.Native detached = this.parent;
                this.parent = null;
