...
public class CommitQueue extends com.cisco.singtel.resourcemanager.base.ParameterTreeNode {
    ...
    private com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.input.commitqueue.Sync _sync;
    ...
    public CommitQueue(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.Input parent) {
        super(null);
        this.parent = parent;
    }
    ...
    * </ul><br>
     ...
     */
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.input.commitqueue.Sync sync() {
        if (this._sync == null) {
            this._sync = new com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.input.commitqueue.Sync(this);
        }
        return this._sync;
    }
    ...
    * </ul><br>
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.input.commitqueue.Sync _attach(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.input.commitqueue.Sync child) {
        if (this._sync != child) {
            if (this._sync != null) {
                com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.input.commitqueue.Sync detached = this._sync;
                this._sync = null;
                detached._detach();
            }
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.input.commitqueue.Sync _detach(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.input.commitqueue.Sync child) {
        com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.input.commitqueue.Sync detached = this._sync;
        this._attach((com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.input.commitqueue.Sync)null);
        return detached;
    }
