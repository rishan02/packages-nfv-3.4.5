...
public class CommitQueue extends com.cisco.singtel.resourcemanager.base.ParameterTreeNode {
    ...
    private com.cisco.singtel.resourcemanager.base.ParameterLeaf<com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.output.commitqueue.Status> _status;

    public CommitQueue(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.Output parent) {
        super(null);
        this.parent = parent;
    }
    ...
    * </ul><br>
     */
    public com.cisco.singtel.resourcemanager.base.ParameterLeaf<com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.output.commitqueue.Status> status() {
        if (this._status == null) {
            this._status = new com.cisco.singtel.resourcemanager.base.ParameterLeaf<com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.output.commitqueue.Status>(this, LEAF_STATUS_PREFIX, LEAF_STATUS_TAG, com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.redeploy.output.commitqueue.Status.CONVERTER);
        }
        return this._status;
    }
