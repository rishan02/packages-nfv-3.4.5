package com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.reactiveredeploy.output;
...
public class CommitQueue extends com.cisco.singtel.resourcemanager.base.ParameterTreeNode {
    ...
    private com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.reactiveredeploy.Output parent;
    ...
    private com.cisco.singtel.resourcemanager.base.ParameterLeaf<com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.reactiveredeploy.output.commitqueue.Status> _status;

    public CommitQueue(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.reactiveredeploy.Output parent) {
        super(null);
        this.parent = parent;
    }
    ...
    * </ul><br>
     */
    public com.cisco.singtel.resourcemanager.base.ParameterLeaf<com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.reactiveredeploy.output.commitqueue.Status> status() {
        if (this._status == null) {
            this._status = new com.cisco.singtel.resourcemanager.base.ParameterLeaf<com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.reactiveredeploy.output.commitqueue.Status>(this, LEAF_STATUS_PREFIX, LEAF_STATUS_TAG, com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.reactiveredeploy.output.commitqueue.Status.CONVERTER);
        }
        return this._status;
    }
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.reactiveredeploy.Output _parent() {
        if (this.parent == null) {
            this.parent = new com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.reactiveredeploy.Output(this._getPath().getParent());
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.reactiveredeploy.Output _attach(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.reactiveredeploy.Output parent) {
        if (this.parent != parent) {
            if (this.parent != null) {
                com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.reactiveredeploy.Output detached = this.parent;
                this.parent = null;
    ...
    public CommitQueue _detach() {
        this._attach((com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.reactiveredeploy.Output)null);
        return this;
    }
