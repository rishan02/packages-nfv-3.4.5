...
public class Device extends com.cisco.singtel.resourcemanager.base.ParameterTreeNode {
    ...
    private com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.checksync.output._native.DeviceList parent;
    ...
    public Device(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.checksync.output._native.DeviceList parent, DeviceListKey key) {
        super(null);
        this.parent = parent;
        this._setKey(key);
    }
    ...
    * </ul><br>
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.checksync.output._native.DeviceList _parent() {
        if (this.parent == null) {
            this.parent = new com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.checksync.output._native.DeviceList(this._getPath().getParent());
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.checksync.output._native.DeviceList _attach(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.checksync.output._native.DeviceList parent) {
        if (this.parent != parent) {
            if (this.parent != null) {
                com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.checksync.output._native.DeviceList detached = this.parent;
                this.parent = null;
