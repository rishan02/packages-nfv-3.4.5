package com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.undeploy.input.commitqueue;
...
public class Sync extends com.cisco.singtel.resourcemanager.base.ParameterTreeNode {
    ...
    private com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.undeploy.input.CommitQueue parent;
    ...
    public Sync(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.undeploy.input.CommitQueue parent) {
        super(null);
        this.parent = parent;
    }
    ...
    * </ul><br>
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.undeploy.input.CommitQueue _parent() {
        if (this.parent == null) {
            this.parent = new com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.undeploy.input.CommitQueue(this._getPath().getParent());
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.undeploy.input.CommitQueue _attach(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.undeploy.input.CommitQueue parent) {
        if (this.parent != parent) {
            if (this.parent != null) {
                com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.objectpool.objects.undeploy.input.CommitQueue detached = this.parent;
                this.parent = null;
