...
public class IdPool extends com.cisco.singtel.resourcemanager.base.DataTreeNode {
    ...
    private com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.IdPoolList parent;
    private boolean exists = false;
    private IdPoolListKey key;
    private com.cisco.singtel.resourcemanager.base.DataLeaf<java.lang.String> _name;
    private com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.RangesList _ranges;
    ...
    private com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.AllocatedByConsumerList _allocatedByConsumer;

    public IdPool(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.IdPoolList parent, IdPoolListKey key) {
        super(null);
        this.parent = parent;
        this._setKey(key);
    }

    public IdPool(se.dataductus.common.nso.path.MaapiPath path) {
        super(path);
        this.parent = null;
        this._setKey(new IdPoolListKey(path.getKey()));
    }
    ...
    * </ul><br>
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.RangesList ranges() {
        if (this._ranges == null) {
            this._ranges = new com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.RangesList(this);
        }
        return this._ranges;
    }
    ...
    * </ul><br>
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.AllocatedByConsumerList allocatedByConsumer() {
        if (this._allocatedByConsumer == null) {
            this._allocatedByConsumer = new com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.AllocatedByConsumerList(this);
        }
        return this._allocatedByConsumer;
    }

    public IdPoolListKey _getKey() {
        return this.key;
    }

    protected void _setKey(IdPoolListKey key) {
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.IdPoolList _parent() {
        if (this.parent == null) {
            this.parent = new com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.IdPoolList(this._getPath().getParent());
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.RangesList _attach(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.RangesList child) {
        if (this._ranges != child) {
            if (this._ranges != null) {
                com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.RangesList detached = this._ranges;
                this._ranges = null;
                detached._detach();
            }
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.RangesList _detach(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.RangesList child) {
        com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.RangesList detached = this._ranges;
        this._attach((com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.RangesList)null);
        return detached;
    }

    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.AllocatedByConsumerList _attach(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.AllocatedByConsumerList child) {
        if (this._allocatedByConsumer != child) {
            if (this._allocatedByConsumer != null) {
                com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.AllocatedByConsumerList detached = this._allocatedByConsumer;
    ...
    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.AllocatedByConsumerList _detach(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.AllocatedByConsumerList child) {
        com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.AllocatedByConsumerList detached = this._allocatedByConsumer;
        this._attach((com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.idpool.AllocatedByConsumerList)null);
        return detached;
    }

    public com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.IdPoolList _attach(com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.IdPoolList parent) {
        if (this.parent != parent) {
            if (this.parent != null) {
                com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.IdPoolList detached = this.parent;
                this.parent = null;
    ...
    public IdPool _detach() {
        this._attach((com.cisco.singtel.resourcemanager.model.singtelrm.resourcemanager.pools.IdPoolList)null);
        return this;
    }

    public IdPool _read(se.dataductus.common.nso.channel.MaapiChannel channel, com.cisco.singtel.resourcemanager.base.Scope scope) {
        return this._read(channel, scope, java.util.EnumSet.of(com.cisco.singtel.resourcemanager.base.Mode.CONFIG));
    }

    public IdPool _read(se.dataductus.common.nso.channel.MaapiChannel channel, com.cisco.singtel.resourcemanager.base.Scope scope, java.util.EnumSet<com.cisco.singtel.resourcemanager.base.Mode> mode) {
    ...
    public IdPool _write(se.dataductus.common.nso.channel.MaapiChannel channel) throws com.tailf.conf.ConfException {
