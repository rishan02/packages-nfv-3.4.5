...
public class WanCvlans extends com.cisco.singtel.resourcemanager.base.ParameterTreeNode {
    ...
    private com.singtel.nfv.model.vcpe.createvcpesubinterfaces.input.WanCvlansList parent;
    ...
    public WanCvlans(com.singtel.nfv.model.vcpe.createvcpesubinterfaces.input.WanCvlansList parent, WanCvlansListKey key) {
        super(null);
        this.parent = parent;
        this._setKey(key);
    }
    ...
    * </ul><br>
    ...
    public com.singtel.nfv.model.vcpe.createvcpesubinterfaces.input.WanCvlansList _parent() {
        if (this.parent == null) {
            this.parent = new com.singtel.nfv.model.vcpe.createvcpesubinterfaces.input.WanCvlansList(this._getPath().getParent());
    ...
    public com.singtel.nfv.model.vcpe.createvcpesubinterfaces.input.WanCvlansList _attach(com.singtel.nfv.model.vcpe.createvcpesubinterfaces.input.WanCvlansList parent) {
        if (this.parent != parent) {
            if (this.parent != null) {
                com.singtel.nfv.model.vcpe.createvcpesubinterfaces.input.WanCvlansList detached = this.parent;
                this.parent = null;
