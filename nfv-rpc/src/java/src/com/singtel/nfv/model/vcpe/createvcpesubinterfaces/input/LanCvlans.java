...
public class LanCvlans extends com.cisco.singtel.resourcemanager.base.ParameterTreeNode {
    ...
    private com.singtel.nfv.model.vcpe.createvcpesubinterfaces.input.LanCvlansList parent;
    ...
    public LanCvlans(com.singtel.nfv.model.vcpe.createvcpesubinterfaces.input.LanCvlansList parent, LanCvlansListKey key) {
        super(null);
        this.parent = parent;
        this._setKey(key);
    }
    ...
    * </ul><br>
    ...
    public com.singtel.nfv.model.vcpe.createvcpesubinterfaces.input.LanCvlansList _parent() {
        if (this.parent == null) {
            this.parent = new com.singtel.nfv.model.vcpe.createvcpesubinterfaces.input.LanCvlansList(this._getPath().getParent());
    ...
    public com.singtel.nfv.model.vcpe.createvcpesubinterfaces.input.LanCvlansList _attach(com.singtel.nfv.model.vcpe.createvcpesubinterfaces.input.LanCvlansList parent) {
        if (this.parent != parent) {
            if (this.parent != null) {
                com.singtel.nfv.model.vcpe.createvcpesubinterfaces.input.LanCvlansList detached = this.parent;
                this.parent = null;
