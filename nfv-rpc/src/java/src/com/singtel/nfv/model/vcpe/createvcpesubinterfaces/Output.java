...
public class Output extends com.cisco.singtel.resourcemanager.base.ParameterTreeNode {
    ...
    private com.cisco.singtel.resourcemanager.base.ParameterLeaf<com.singtel.nfv.model.vcpe.createvcpesubinterfaces.output.Result> _result;
    private com.cisco.singtel.resourcemanager.base.ParameterLeaf<java.lang.String> _successMessage;
    private com.cisco.singtel.resourcemanager.base.ParameterLeaf<com.singtel.nfv.model.vcpe.createvcpesubinterfaces.output.Errno> _errno;

    public Output(com.singtel.nfv.model.vcpe.CreateVcpeSubinterfaces parent) {
        super(null);
    }
    ...
    * </ul><br>
     */
    public com.cisco.singtel.resourcemanager.base.ParameterLeaf<com.singtel.nfv.model.vcpe.createvcpesubinterfaces.output.Result> result() {
        if (this._result == null) {
            this._result = new com.cisco.singtel.resourcemanager.base.ParameterLeaf<com.singtel.nfv.model.vcpe.createvcpesubinterfaces.output.Result>(this, LEAF_RESULT_PREFIX, LEAF_RESULT_TAG, com.singtel.nfv.model.vcpe.createvcpesubinterfaces.output.Result.CONVERTER);
        }
        return this._result;
    }
    ...
    * </ul><br>
     */
    public com.cisco.singtel.resourcemanager.base.ParameterLeaf<com.singtel.nfv.model.vcpe.createvcpesubinterfaces.output.Errno> errno() {
        if (this._errno == null) {
            this._errno = new com.cisco.singtel.resourcemanager.base.ParameterLeaf<com.singtel.nfv.model.vcpe.createvcpesubinterfaces.output.Errno>(this, LEAF_ERRNO_PREFIX, LEAF_ERRNO_TAG, com.singtel.nfv.model.vcpe.createvcpesubinterfaces.output.Errno.CONVERTER);
        }
        return this._errno;
    }
