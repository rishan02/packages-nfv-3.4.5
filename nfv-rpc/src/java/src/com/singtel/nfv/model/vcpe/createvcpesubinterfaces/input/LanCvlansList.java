...
public class LanCvlansList extends com.cisco.singtel.resourcemanager.base.ParameterTreeNode implements java.lang.Iterable<LanCvlans> {
    ...
    private com.singtel.nfv.model.vcpe.createvcpesubinterfaces.Input parent;
    private boolean exists = false;
    private final java.util.SortedMap<LanCvlansListKey, LanCvlans> elemCache = new java.util.TreeMap<>();

    public LanCvlansList(com.singtel.nfv.model.vcpe.createvcpesubinterfaces.Input parent) {
        super(null);
        this.parent = parent;
    }
    ...
    public com.singtel.nfv.model.vcpe.createvcpesubinterfaces.Input _parent() {
        if (this.parent == null) {
            this.parent = new com.singtel.nfv.model.vcpe.createvcpesubinterfaces.Input(this._getPath().getParent());
    ...
    public com.singtel.nfv.model.vcpe.createvcpesubinterfaces.Input _attach(com.singtel.nfv.model.vcpe.createvcpesubinterfaces.Input parent) {
        if (this.parent != parent) {
            if (this.parent != null) {
                com.singtel.nfv.model.vcpe.createvcpesubinterfaces.Input detached = this.parent;
                this.parent = null;
    ...
    public LanCvlansList _detach() {
        this._attach((com.singtel.nfv.model.vcpe.createvcpesubinterfaces.Input)null);
        return this;
    }
