...
call-home
 ...
 profile minthein
  ...
  destination address email mgmint@singtel.com
  destination address http http://172.17.11.15:18080/Transportgateway/services/DeviceRequestHandler 
!
license smart enable
do license smart register idtoken OWEyZDNhYzUtZGE5OS00YTkxLTgxOGMtNGJhOGQwZjgwY2NjLTE0NzYyNzYx%0ANzAyODN8azVObnFmV1RLdTZYMytSNWlxMUsvSnZuQ0NseVl4YWNQUjllbnQv%0AU0EvZz0%3D%0A
...
!         
!         
ip route vrf Mgmt 0.0.0.0 0.0.0.0 172.17.32.1
!    
access-list 40 permit 172.17.11.0 0.0.0.255
access-list 40 permit 172.17.32.0 0.0.0.255
